...
class PiperGoUtils implements Serializable {
    ...
    void unstashPiperBin() {
        ...
        if (steps.env.REPOSITORY_UNDER_TEST && steps.env.LIBRARY_VERSION_UNDER_TEST) {
            ...
            def fallbackUrl = 'https://github.com/maryia-haladko/jenkins-library/releases/latest/download/piper_master'
            def piperBinUrl = (version == 'master') ? fallbackUrl : "https://github.com/maryia-haladko/jenkins-library/releases/download/${version}/piper"
